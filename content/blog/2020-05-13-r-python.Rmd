...
![](/blog/2020-05-13-r-python_files/blogpic.jpg)
  ...
  When I heard about a ~9-hour hike down the canyon I saw an exciting challenge. However, as a fitness nerd who was trying to put on weight I did not want to go at a caloric deficit for the day so, I decided to calculate about how much calories I would burn during the hike so that I know how much more food I need to eat to maintain a caloric surplus for the day (aka putting on weight).
...
#calories burned during the hike
c_hiking<- 710*8.75
...
```{R}
df <- data.frame("meal" = c("breakfast","snack1","lunch","snack2","dinner","snack3"), "calories" = c(1425, 500, 1575, 450, 2000, 550))
```
...
#now selecting and filtering to see the 2000 calorie meal
